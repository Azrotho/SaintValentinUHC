...
public class CoupleUpdate {
    public static void update(SVCouple couple) {
        ...
        if(couple.getTime() == 600 && couple.getState().equals("kiff")) {
            ...
            player1.sendMessage(SVUhc.getInstance().getTag() + "§fOn dirait bien que le stade du simple kiff est passé, vous êtes désormais en crush avec avec §d§l"+ player2.getName() + "§7, vous gagnez ainsi deux coeurs d'abso non définitifs !");
            player2.sendMessage(SVUhc.getInstance().getTag() + "§fOn dirait bien que le stade du simple kiff est passé, vous êtes désormais en crush avec avec §d§l"+ player1.getName() + "§7, vous gagnez ainsi deux coeurs d'abso non définitifs !");
        ...
        if(couple.getTime() == 600 && couple.getState().equals("canard")) {
            ...
            player1.sendMessage(SVUhc.getInstance().getTag() + "§fOn dirait bien que l'heure est à la demande...Vous venez de vous passer la bague au doigts, vous êtes fillancés avec §d§l" + player2.getName() + "§7, vous gagnez donc 2 coeurs définitifs supplémentaires et perdez votre effet weakness 1");
            player2.sendMessage(SVUhc.getInstance().getTag() + "§fOn dirait bien que l'heure est à la demande...Vous venez de vous passer la bague au doigts, vous êtes fillancés avec §d§l" + player1.getName() + "§7, vous gagnez donc 2 coeurs définitifs supplémentaires et perdez votre effet weakness 1");
